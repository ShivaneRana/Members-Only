...
const validationObject = [
  ...
  body("username")
    ...
    .isLength({max:64}).withMessage("Username cannot have more than 64 characters")
    .matches(/^[A-Za-z0-9!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+$/).withMessage("Username can contain only letters, numbers, and special characters"),
  ...
  body("password")
    ...
    .matches(/^[A-Za-z0-9!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]+$/).withMessage("Password can contain only letters, numbers, and special characters"),
